...
class VTPTipInertia(om.ExplicitComponent):
    """Estimate symmetric H-wing VTP mass properties relative to the wing elastic axis."""
    ...
    def compute(self, inputs, outputs):
        ...
        vtp_mass = inputs[Aircraft.VerticalTail.MASS]
        ...
        pitch_inertia = equivalent_mass_per_span * (dx_to_ea**2 + z_centroid_abs**2)
